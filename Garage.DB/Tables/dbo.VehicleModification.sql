...
GO
ALTER TABLE [dbo].[VehicleModification] ADD CONSTRAINT [PK_VehicleModification] PRIMARY KEY CLUSTERED  ([VehicleModificationID]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[VehicleModification] ADD CONSTRAINT [fk_VehicleModificationModel] FOREIGN KEY ([VehicleModelID]) REFERENCES [dbo].[VehicleModel] ([VehicleModelID])
GO
