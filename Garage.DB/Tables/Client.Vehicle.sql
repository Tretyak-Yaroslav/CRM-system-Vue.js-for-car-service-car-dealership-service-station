...
GO
ALTER TABLE [Client].[Vehicle] ADD CONSTRAINT [PK_Vehicle] PRIMARY KEY CLUSTERED  ([VehicleID]) ON [PRIMARY]
GO
ALTER TABLE [Client].[Vehicle] ADD CONSTRAINT [fk_VehicleModification] FOREIGN KEY ([VehicleModelID]) REFERENCES [Client].[VehicleModel] ([VehicleModelID])
GO
