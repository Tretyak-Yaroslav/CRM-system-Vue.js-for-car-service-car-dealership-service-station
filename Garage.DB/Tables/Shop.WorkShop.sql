...
GO
ALTER TABLE [Shop].[WorkShop] ADD CONSTRAINT [PK__Station__E0D8A6DD6C2FF3C5] PRIMARY KEY CLUSTERED  ([WorkShopID]) ON [PRIMARY]
GO
ALTER TABLE [Shop].[WorkShop] ADD CONSTRAINT [fk_StationParent] FOREIGN KEY ([ParentWorkShopID]) REFERENCES [Shop].[WorkShop] ([WorkShopID])
GO
