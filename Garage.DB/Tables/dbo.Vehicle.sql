...
[VehicleModificationID] [int] NULL,
...
GO
ALTER TABLE [dbo].[Vehicle] ADD CONSTRAINT [fk_VehicleModification] FOREIGN KEY ([VehicleModificationID]) REFERENCES [dbo].[VehicleModification] ([VehicleModificationID])
GO
